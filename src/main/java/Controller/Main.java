...
//        name_game.setY(300);
        ...
        name_game.setFont(Font.font("file:src/main/java/webapp/fonts/OptimusPrinceps.ttf", FontWeight.BOLD, 30));

        Text minesweeper = new Text(n_game);
        minesweeper.setFill(Color.WHITE);
        minesweeper.setFont(Font.font("file:src/main/java/webapp/fonts/OptimusPrinceps.ttf", FontWeight.BOLD, 40));

        Text help_text = new Text(help_t);
        help_text.setFill(Color.WHITE);
        help_text.setFont(Font.font("file:src/main/java/webapp/fonts/OptimusPrinceps.ttf", FontWeight.BOLD, 14));
...
//        start_scene.setLayoutY(150);
        ...
        rules_text.setFont(Font.font("file:src/main/java/webapp/fonts/OptimusPrinceps.ttf", FontWeight.BOLD, 16));
        ...
        String main_music = "src/main/webapp/music/mainTheme.mp3";
        Media main_mus = new Media(new File(main_music).toURI().toString());
        ...
        scene.setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.ESCAPE && !escappe) {
                String path_music = "src/main/webapp/music/sound_click.mp3";
